            ...
            switch (choice) {
                ...
                case 2 :
                    if(customers.isEmpty()){
                        ...
                        String remove = customers.remove();
                ...
                case 3 :
                    if(customers.isEmpty()){
                        ...
                        System.out.println("next customer: " + customers.element());
                    }
                    break;
                case 4 :

                    System.out.println("enter customer name");
                    String cnamee = input.next();
                    if (customers.contains(cnamee)) {
                ...
                case 5 :
                    if(customers.isEmpty()){
                        ...
                        for(String c : customers) {
                            System.out.println("Display all print jobs :" + c);
                        }
                    }
                    break;
                case 6 :
                    ...
                    if(customers.isEmpty()) {
                        ...
                        System.out.println("First customer in the queue   : " + customers.element());
                        System.out.println("Last customer in the queue : " + ((LinkedList<String>) customers).getLast());
